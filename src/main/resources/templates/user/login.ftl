    ...
    <div class="layui-layout layui-layout-admin" style="height: 100%">
        <div class="layui-header" style="background-color: #2066CE">
            <div style="padding-left: 5px; width: 600px; height: 60px">
                <!-- 在这里替换具体的LOGO和标语 -->
                <img width="60px" src="static/images/logos/1630982987559.gif" style="float: right; margin-top: 5px">
                <!-- color:#009688-->
                <div style="color: #E6E6E6; margin-left:20px;float:left;width:300px;height:100%;line-height:60px;text-align:left;font-size:16px;">..支付管理系统</div>
            </div>
