        ...
        <div class="layui-col-md6">
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    ...
                    <div style="margin-bottom: 10px">
                        <label class="layui-form-label">成果编码</label>
                        <div class="layui-input-block" style="width: 200px">
...
<script type="text/html" id="toolbar">
    <div class="layui-btn-container">
        <button class="layui-btn layui-btn-sm" lay-event="addEmployee">添加订单</button>
    </div>
</script>
    ...
    layui.use('table', function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field:'name', width:120, title: '订单编号'},
                {field:'sex', width:80, title: '状态', templet:function (row) {
                        return [
                            '<div>',
                            row.sex == 0 ? '启用' : '未启用',
                            '</div>'
                ...
                {field:'education', width: 100, title:'成果', templet: '#educationTpl'},
                {field:'idcard', width: 160, title:'成果编码', edit: true},
                <!--{field:'address', width: 140, title:'地址', edit: true},-->
                {field:'position.name', width: 150, title:'订单类型', templet: '#positionTpl'

                },
                /*{field:'position.name', width: 110, title:'订单', templet: function (d) {
